...
function moveTextToCenter() {
    ...
    leftSideDiv.classList.add('move-right');
        ...
        console.log("mtl");
        rightSideDiv.addEventListener('animationend', function() {
            rightSideDiv.classList.remove('move-left');
        }, { once: true });
        leftSideDiv.addEventListener('animationend', function() {
            leftSideDiv.classList.remove('move-left');
        }, { once: true });


    // leftSideDiv.removeEventListener('transitionend', transitionEndHandler);
    // rightSideDiv.removeEventListener('transitionend', transitionEndHandler);
